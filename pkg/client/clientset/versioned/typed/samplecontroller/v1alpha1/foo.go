...
import (
	v1alpha1 "github.com/afritzler/sample-k8s-controller/pkg/apis/samplecontroller/v1alpha1"
	scheme "github.com/afritzler/sample-k8s-controller/pkg/client/clientset/versioned/scheme"
